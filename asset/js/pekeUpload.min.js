 ...
 */
(function($) {
    var urll = "http://10.6.101.72/training/tool/model/upload_sertificate.php";
    $.fn.pekeUpload = function(options) {
        ...
        function UploadFile() {
            if($("#m-select").val() && $("#month").val()){
                ...
                formData.append('select', $("#m-select").val());
                ...
                $("#text-msg").html('Week & Month report are mandatory !');
                $("#ov-dialog").slideToggle();
            }
        }
