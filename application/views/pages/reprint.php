...
$html = '
		 <table border="0">
		 	<tr>
		 		<td colspan="2" style="text-align:center; font-size:10pt;">ORDER RECEIPT '.strtoupper($terminal).'<br/>(Reprint Customer)</td>
		 		<td></td>		 		
		 	</tr>
		 	<tr>
...
// This method has several options, check the source code documentation for more information.
$pdf->Output('Reprint_Receipt_order_'.$barcode.'.pdf', 'I');
